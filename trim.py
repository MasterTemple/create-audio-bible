...
def trim_file(id: str, start_time: float, end_time: float, volume: float=1.0):
    ...
    output_file = os.path.join(PROJECT_DIR, project_name, PROJECT_DIR_AUDIO_TRIM, f'{id}-{start_time}-{end_time}-{volume}.mp3')
